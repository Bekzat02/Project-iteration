...
<div class="basy">
    ...
    <div class="birinshi">
        ...
        <div class="current">
            Current
            <select>
                <option value="" onclick="Message()">USD</option>
                <option value="">EURO</option>
                <option value="" onclick="revealMessage()"> KZT</option>
            </select>
        </div>
    </div>
    <div></div>
    ...
    <div class="ekinshi">
        ...
        <div class="eki"> <a href="registrationfrom.php" style="font-size: 12px; color: white;">
                 <?php echo $_SESSION['logged_user']->fname?>  <i class="fas fa-user"></i></a>
        </div>
    ...
    <div class="container">
        ...
        <div class="row ml-1">
            <div class="container-fluid col-lg-4 text-center">
                ...
                <div><p id="beka" style="display: block;"> 30.99$ </p> <p id="hiddenMessage" style="display: none; ">13000 KZT</p></div>
