...
<div class="navbar">
    ...
    <ul>
        <li><a href="projectt.html">HOME</a></li>
...
<form  action="registrationfrom.php" method="POST">
    <div class="regis">
        ...
        <input type="email" name="email" style="width: 40%;" value="<?php echo @$data['email'] ?>">
        <br><br>
        <div><label for="password">Password</label></div>
        <input type="password" name="password" style="width: 40%;" value="<?php echo @$data['password'] ?>">
        <div><a href="#">Forgot your password ?</a></div>
        <br>
        <button style="width: 40%;" name="do_login">Sign in</button>
    </div>
</form>
</div>
</div>
...
<form class="regis" action="registrationfrom.php" method="POST">
    ...
    <input type="password" name="password_2" id="password" style="width: 40%;"
...
<div class="astyndagy">
    ...
    <div class="first">
        <div class="fff">
            <h4>GET IN TOUCH</h4>
            <p>bekzatkahmetov02@gmail.com <a href="contact.html" style="color: rgb(136, 32, 32); font-weight: bold ;">Contact
                    us</a></p>
